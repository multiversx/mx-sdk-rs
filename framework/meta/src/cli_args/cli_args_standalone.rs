...
pub enum StandaloneCliAction {
    ...
    #[command(
        name = "test-coverage-render",
        about = "Render pretty output from test coverage result"
    )]
    TestCoverageRender(TestCoverageRenderArgs),
...
#[derive(Default, Clone, PartialEq, Eq, Debug, Args)]
pub struct TestCoverageRenderArgs {
    /// Input file path (llvm-cov json5 format)
    /// Generated by the llvm-cov export tool
    #[arg(short, long, verbatim_doc_comment)]
    pub input: String,
