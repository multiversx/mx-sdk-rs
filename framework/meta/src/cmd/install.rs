...
pub fn install(args: &InstallArgs) {
    ...
    match command {
        InstallCommand::All => {
            ...
            install_debugger(&InstallDebuggerArgs::default());
        },
        ...
        InstallCommand::Debugger(debugger_args) => install_debugger(debugger_args),
    }
}
...
fn install_debugger(_debugger_args: &InstallDebuggerArgs) {
