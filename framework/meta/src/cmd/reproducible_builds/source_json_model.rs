...
pub const DEFAULT_BUILD_ROOT_FOLDER: &str = "/tmp/sc-build";
...
pub struct SourceMetadata {
    ...
    #[serde(default)]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub build_options: Option<SourceBuildOptions>,
}

impl SourceMetadata {
    pub fn build_root_folder(&self) -> &str {
        self.build_options
            .as_ref()
            .map(|o| o.build_root_folder.as_str())
            .unwrap_or(DEFAULT_BUILD_ROOT_FOLDER)
    }
}
