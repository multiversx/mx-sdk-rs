...
mod returns_bt_legacy_multi_esdt;
...
pub use has_managed::HasManaged;
...
pub use returns_bt_legacy_multi_esdt::ReturnsBackTransfersLegacyMultiESDT;
...
pub use returns_result_managed::ReturnsResultManaged;
