...
use super::{
    FunctionCall, Tx, TxCallback, TxDataFunctionCall, TxEnv, TxPayment, TxScEnv, TxToSpecified,
};

pub trait TxAsyncCallCallback<Api>: TxCallback<TxScEnv<Api>>
where
    Api: CallTypeApi,
{
...
impl<Api> TxCallback<TxScEnv<Api>> for CallbackClosure<Api> where Api: CallTypeApi {}
...
impl<Api> TxCallback<TxScEnv<Api>> for Option<CallbackClosure<Api>> where Api: CallTypeApi {}
...
impl<Api, To, Payment, FC, Callback> Tx<TxScEnv<Api>, (), To, Payment, (), FC, Callback>
where
    Api: CallTypeApi,
    To: TxToSpecified<TxScEnv<Api>>,
    Payment: TxPayment<TxScEnv<Api>>,
    FC: TxDataFunctionCall<TxScEnv<Api>>,
    Callback: TxAsyncCallCallback<Api>,
{
    pub fn async_call_and_exit(self) -> ! {
        let normalized = self.normalize_tx();
        normalized.callback.save_callback_closure_to_storage();
