...
use super::BaseBigUint;

impl<M: ManagedTypeApi> PartialEq for BaseBigUint<M> {
    #[inline]
...
impl<M: ManagedTypeApi> Eq for BaseBigUint<M> {}

impl<M: ManagedTypeApi> PartialOrd for BaseBigUint<M> {
    #[inline]
...
impl<M: ManagedTypeApi> Ord for BaseBigUint<M> {
    #[inline]
...
macro_rules! partial_eq_and_ord {
    ($small_int_type:ident) => {
        impl<M: ManagedTypeApi> PartialEq<$small_int_type> for BaseBigUint<M> {
            #[inline]
        ...
        impl<M: ManagedTypeApi> PartialOrd<$small_int_type> for BaseBigUint<M> {
            #[inline]
