...
pub trait EndpointArgumentApi<'a>: HandleTypeInfo {
    type EndpointArgumentApiImpl: EndpointArgumentApiImpl<'a>
        + HandleTypeInfo<
...
pub trait EndpointArgumentApiImpl<'a>: ErrorApi + ManagedTypeApi<'a> {
