...
pub fn signal_arg_de_error<'a, EA>(arg_id: ArgId, decode_err: DecodeError) -> !
where
    EA: ManagedTypeApi<'a> + ErrorApi,
{
    ...
    EA::error_api_impl().signal_error_from_buffer(message_buffer.take_handle())
}
