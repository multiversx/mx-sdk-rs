...
macro_rules! impl_scenario_runner_list {
    ($name:ident, $($list_types:ident),+) => {
...
impl_scenario_runner_list!(ScenarioRunnerList, ScenarioRunner);
impl_scenario_runner_list!(ScenarioRunnerListSafe, ScenarioRunner,Send,Sync);
