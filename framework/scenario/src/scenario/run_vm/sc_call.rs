...
use multiversx_chain_vm::{
    tx_execution::{instance_call, sc_call_with_async_and_callback, RuntimeInstanceCall},
...
impl ScenarioVMRunner {
        ...
        F: FnOnce(RuntimeInstanceCall<'_>),
    {
        ...
        sc_call_with_async_and_callback(tx_input, &mut self.blockchain_mock.state, &runtime, f)
    }
