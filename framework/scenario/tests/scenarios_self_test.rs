...
#[test]
fn transfer_egld_rs() {
    multiversx_sc_scenario::scenario_rs("tests/scenarios-self/transfer-egld.scen.json", world());
}

#[test]
fn transfer_esdt_rs() {
    multiversx_sc_scenario::scenario_rs("tests/scenarios-self/transfer-esdt.scen.json", world());
}

#[test]
fn validator_reward_rs() {
    multiversx_sc_scenario::scenario_rs("tests/scenarios-self/validatorReward.scen.json", world());
}
