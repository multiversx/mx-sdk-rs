...
pub fn generate_call_method_arg_load(m: &Method) -> proc_macro2::TokenStream {
    ...
    quote! {
        let #var_names = multiversx_sc::io::load_endpoint_args::<CurrentApi, #var_types>(#var_names_str);
    }
}
...
pub fn load_call_result_args_snippet(m: &Method) -> proc_macro2::TokenStream {
    ...
    quote! {
        let #call_result_var_names = multiversx_sc::io::load_endpoint_args::<CurrentApi,#call_result_var_types>(
...
pub fn load_legacy_cb_closure_args_snippet(m: &Method) -> proc_macro2::TokenStream {
    ...
    quote! {
        let #closure_var_names = multiversx_sc::io::load_multi_args_custom_loader::<CurrentApi, _, #closure_var_types>(
