use crate::{address_h256_to_erdrs, mandos_to_erdrs_address, tx_response_from_network, Interactor};
use log::info;
...
impl Interactor {
        ...
        S: AsMut<ScCallStep>,
    {
        ...
        sc_call_step.save_response(tx_response_from_network::parse_tx_response(tx));
