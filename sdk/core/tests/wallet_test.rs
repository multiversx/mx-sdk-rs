...
fn test_get_shard() {
    ...
    assert_eq!(0, alice.address.shard_of_3().as_u32());
    ...
    assert_eq!(2, bob.address.shard_of_3().as_u32());
    ...
    assert_eq!(0, carol.address.shard_of_3().as_u32());
    ...
    assert_eq!(1, heidi.address.shard_of_3().as_u32());
