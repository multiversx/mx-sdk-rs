...
stat --printf="crowdfunding-egld %s\n" contracts/examples/crowdfunding-egld/output/crowdfunding-egld.wasm
...
stat --printf="lottery-egld %s\n" contracts/examples/lottery-egld/output/lottery-egld.wasm
