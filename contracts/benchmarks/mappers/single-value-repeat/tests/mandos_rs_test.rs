...
fn single_value_repeat_struct_rs() {
    multiversx_sc_scenario::scenario_rs("scenarios/single_value_repeat_struct.scen.json", world());
}

#[test]
fn single_value_repeat_rs() {
    multiversx_sc_scenario::scenario_rs("scenarios/single_value_repeat.scen.json", world());
}
