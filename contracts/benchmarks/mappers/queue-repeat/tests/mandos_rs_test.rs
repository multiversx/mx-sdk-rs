...
fn queue_repeat_struct_rs() {
    multiversx_sc_scenario::scenario_rs("scenarios/queue_repeat_struct.scen.json", world());
}

#[test]
fn queue_repeat_rs() {
    multiversx_sc_scenario::scenario_rs("scenarios/queue_repeat.scen.json", world());
}
