...
fn allowance_callercaller_rs() {
    mx_sc_scenario::scenario_rs("scenarios/allowance_CallerCaller.scen.json", world());
}

#[test]
fn allowance_callerother_rs() {
    mx_sc_scenario::scenario_rs("scenarios/allowance_CallerOther.scen.json", world());
}

#[test]
fn allowance_othercaller_rs() {
    mx_sc_scenario::scenario_rs("scenarios/allowance_OtherCaller.scen.json", world());
}

#[test]
fn allowance_othereqother_rs() {
    mx_sc_scenario::scenario_rs("scenarios/allowance_OtherEqOther.scen.json", world());
}

#[test]
fn allowance_otherneqother_rs() {
    mx_sc_scenario::scenario_rs("scenarios/allowance_OtherNEqOther.scen.json", world());
}

#[test]
fn approve_caller_positive_rs() {
    mx_sc_scenario::scenario_rs("scenarios/approve_Caller-Positive.scen.json", world());
}

#[test]
fn approve_caller_zero_rs() {
    mx_sc_scenario::scenario_rs("scenarios/approve_Caller-Zero.scen.json", world());
}

#[test]
fn approve_other_positive_rs() {
    mx_sc_scenario::scenario_rs("scenarios/approve_Other-Positive.scen.json", world());
}

#[test]
fn approve_other_zero_rs() {
    mx_sc_scenario::scenario_rs("scenarios/approve_Other-Zero.scen.json", world());
}

#[test]
fn approve_switchcaller_rs() {
    mx_sc_scenario::scenario_rs("scenarios/approve_SwitchCaller.scen.json", world());
}

#[test]
fn balanceof_caller_rs() {
    mx_sc_scenario::scenario_rs("scenarios/balanceOf_Caller.scen.json", world());
}

#[test]
fn balanceof_noncaller_rs() {
    mx_sc_scenario::scenario_rs("scenarios/balanceOf_NonCaller.scen.json", world());
}

#[test]
fn not_payable_rs() {
    mx_sc_scenario::scenario_rs("scenarios/not_payable.scen.json", world());
}

#[test]
fn totalsupply_positive_rs() {
    mx_sc_scenario::scenario_rs("scenarios/totalSupply_Positive.scen.json", world());
}

#[test]
fn totalsupply_zero_rs() {
    mx_sc_scenario::scenario_rs("scenarios/totalSupply_Zero.scen.json", world());
}
...
fn transfer_caller_entirebalance_rs() {
    mx_sc_scenario::scenario_rs("scenarios/transfer_Caller-EntireBalance.scen.json", world());
}
...
fn transfer_caller_nooverflow_rs() {
    mx_sc_scenario::scenario_rs("scenarios/transfer_Caller-NoOverflow.scen.json", world());
}

#[test]
fn transfer_caller_positive_rs() {
    mx_sc_scenario::scenario_rs("scenarios/transfer_Caller-Positive.scen.json", world());
}
...
fn transfer_caller_zero_rs() {
    mx_sc_scenario::scenario_rs("scenarios/transfer_Caller-Zero.scen.json", world());
}
...
fn transfer_other_entirebalance_rs() {
    mx_sc_scenario::scenario_rs("scenarios/transfer_Other-EntireBalance.scen.json", world());
}
...
fn transfer_other_nooverflow_rs() {
    mx_sc_scenario::scenario_rs("scenarios/transfer_Other-NoOverflow.scen.json", world());
}

#[test]
fn transfer_other_positive_rs() {
    mx_sc_scenario::scenario_rs("scenarios/transfer_Other-Positive.scen.json", world());
}
...
fn transfer_other_zero_rs() {
    mx_sc_scenario::scenario_rs("scenarios/transfer_Other-Zero.scen.json", world());
}
