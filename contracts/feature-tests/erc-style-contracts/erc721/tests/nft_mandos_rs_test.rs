...
fn nft_approve_non_existent_token_rs() {
    mx_sc_debug::mandos_rs("mandos/nft-approve-non-existent-token.scen.json", world());
}

#[test]
fn nft_approve_non_owned_token_rs() {
    mx_sc_debug::mandos_rs("mandos/nft-approve-non-owned-token.scen.json", world());
}

#[test]
fn nft_approve_ok_rs() {
    mx_sc_debug::mandos_rs("mandos/nft-approve-ok.scen.json", world());
}

#[test]
fn nft_init_rs() {
    mx_sc_debug::mandos_rs("mandos/nft-init.scen.json", world());
}
...
fn nft_revoke_non_approved_rs() {
    mx_sc_debug::mandos_rs("mandos/nft-revoke-non-approved.scen.json", world());
}

#[test]
fn nft_revoke_ok_rs() {
    mx_sc_debug::mandos_rs("mandos/nft-revoke-ok.scen.json", world());
}

#[test]
fn nft_transfer_approved_token_rs() {
    mx_sc_debug::mandos_rs("mandos/nft-transfer-approved-token.scen.json", world());
}

#[test]
fn nft_transfer_non_existent_token_rs() {
    mx_sc_debug::mandos_rs("mandos/nft-transfer-non-existent-token.scen.json", world());
}
...
fn nft_transfer_ok_rs() {
    mx_sc_debug::mandos_rs("mandos/nft-transfer-ok.scen.json", world());
}

#[test]
fn nft_transfer_token_after_revoked_rs() {
    mx_sc_debug::mandos_rs("mandos/nft-transfer-token-after-revoked.scen.json", world());
}
...
fn nft_transfer_token_ok_rs() {
    mx_sc_debug::mandos_rs("mandos/nft-transfer-token-ok.scen.json", world());
}
