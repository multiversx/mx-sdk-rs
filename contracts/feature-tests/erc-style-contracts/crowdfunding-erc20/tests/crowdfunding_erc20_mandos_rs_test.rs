...
fn deploy_erc20_and_crowdfunding_rs() {
    mx_sc_debug::mandos_rs("mandos/deploy_erc20_and_crowdfunding.scen.json", world());
}

#[test]
fn fund_with_insufficient_allowance_rs() {
    mx_sc_debug::mandos_rs("mandos/fund_with_insufficient_allowance.scen.json", world());
}

#[test]
fn fund_with_sufficient_allowance_rs() {
    mx_sc_debug::mandos_rs("mandos/fund_with_sufficient_allowance.scen.json", world());
}

#[test]
fn fund_without_allowance_rs() {
    mx_sc_debug::mandos_rs("mandos/fund_without_allowance.scen.json", world());
}
