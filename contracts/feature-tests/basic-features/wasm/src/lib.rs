...
#[no_mangle]
pub fn init() {
    basic_features::endpoints::init(elrond_wasm_node::arwen_api());
}
...
pub fn add_assign_big_int() {
    basic_features::endpoints::add_assign_big_int(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn add_assign_big_int_ref() {
    basic_features::endpoints::add_assign_big_int_ref(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn add_assign_big_uint() {
    basic_features::endpoints::add_assign_big_uint(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn add_assign_big_uint_ref() {
    basic_features::endpoints::add_assign_big_uint_ref(elrond_wasm_node::arwen_api());
}
...
pub fn div_assign_big_int() {
    basic_features::endpoints::div_assign_big_int(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn div_assign_big_int_ref() {
    basic_features::endpoints::div_assign_big_int_ref(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn div_assign_big_uint() {
    basic_features::endpoints::div_assign_big_uint(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn div_assign_big_uint_ref() {
    basic_features::endpoints::div_assign_big_uint_ref(elrond_wasm_node::arwen_api());
}
...
pub fn echo_boxed_array_u8() {
    basic_features::endpoints::echo_boxed_array_u8(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn echo_boxed_bytes() {
    basic_features::endpoints::echo_boxed_bytes(elrond_wasm_node::arwen_api());
}
...
pub fn echo_boxed_ser_example_2() {
    basic_features::endpoints::echo_boxed_ser_example_2(elrond_wasm_node::arwen_api());
}
...
pub fn echo_managed_address() {
    basic_features::endpoints::echo_managed_address(elrond_wasm_node::arwen_api());
}
...
pub fn echo_managed_vec_of_managed_vec() {
    basic_features::endpoints::echo_managed_vec_of_managed_vec(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn echo_managed_vec_of_token_identifier() {
    basic_features::endpoints::echo_managed_vec_of_token_identifier(elrond_wasm_node::arwen_api());
}
...
#[no_mangle]
pub fn logEventA() {
    basic_features::endpoints::logEventA(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn logEventB() {
    basic_features::endpoints::logEventB(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn logLegacyEventA() {
    basic_features::endpoints::logLegacyEventA(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn logLegacyEventB() {
    basic_features::endpoints::logLegacyEventB(elrond_wasm_node::arwen_api());
}
...
pub fn only_owner_endpoint() {
    basic_features::endpoints::only_owner_endpoint(elrond_wasm_node::arwen_api());
}
...
#[no_mangle]
pub fn result_echo() {
    basic_features::endpoints::result_echo(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn result_echo_2() {
    basic_features::endpoints::result_echo_2(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn result_echo_3() {
    basic_features::endpoints::result_echo_3(elrond_wasm_node::arwen_api());
}
...
#[no_mangle]
pub fn store_addr() {
    basic_features::endpoints::store_addr(elrond_wasm_node::arwen_api());
}
...
#[no_mangle]
pub fn store_map1() {
    basic_features::endpoints::store_map1(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn store_map2() {
    basic_features::endpoints::store_map2(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn store_map3() {
    basic_features::endpoints::store_map3(elrond_wasm_node::arwen_api());
}
...
pub fn store_reserved_big_uint() {
    basic_features::endpoints::store_reserved_big_uint(elrond_wasm_node::arwen_api());
}
...
pub fn token_attributes_get_attributes() {
    basic_features::endpoints::token_attributes_get_attributes(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn token_attributes_get_nonce() {
    basic_features::endpoints::token_attributes_get_nonce(elrond_wasm_node::arwen_api());
}
...
pub fn token_identifier_egld() {
    basic_features::endpoints::token_identifier_egld(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn token_identifier_is_valid_1() {
    basic_features::endpoints::token_identifier_is_valid_1(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn token_identifier_is_valid_2() {
    basic_features::endpoints::token_identifier_is_valid_2(elrond_wasm_node::arwen_api());
}
