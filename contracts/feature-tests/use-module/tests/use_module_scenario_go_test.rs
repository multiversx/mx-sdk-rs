...
fn use_module_claim_developer_rewards_go() {
    multiversx_sc_scenario::run_go("scenarios/use_module_claim_developer_rewards.scen.json");
}

#[test]
fn use_module_dns_register_go() {
    multiversx_sc_scenario::run_go("scenarios/use_module_dns_register.scen.json");
}

#[test]
fn use_module_features_go() {
    multiversx_sc_scenario::run_go("scenarios/use_module_features.scen.json");
}

#[test]
fn use_module_internal_go() {
    multiversx_sc_scenario::run_go("scenarios/use_module_internal.scen.json");
}
...
fn use_module_only_admin_go() {
    multiversx_sc_scenario::run_go("scenarios/use_module_only_admin.scen.json");
}
