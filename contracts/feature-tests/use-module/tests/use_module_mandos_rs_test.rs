...
fn cancel_defeated_proposal_rs() {
    elrond_wasm_debug::mandos_rs("mandos/use_module_governance/cancel_defeated_proposal.scen.json", &contract_map());
}

#[test]
fn change_configuration_rs() {
    elrond_wasm_debug::mandos_rs("mandos/use_module_governance/change_configuration.scen.json", &contract_map());
}

#[test]
fn init_rs() {
    elrond_wasm_debug::mandos_rs("mandos/use_module_governance/init.scen.json", &contract_map());
}

#[test]
fn invalid_proposals_rs() {
    elrond_wasm_debug::mandos_rs("mandos/use_module_governance/invalid_proposals.scen.json", &contract_map());
}
