...
fn test_token_merge() {
    ...
    let nft_transfers = vec![
        TestEsdtTransfer(NFT_TOKEN_ID_EXPR, FIRST_NFT_NONCE.into(), NFT_AMOUNT.into()),
        TestEsdtTransfer(
            NFT_TOKEN_ID_EXPR,
    ...
    world
        ...
        .whitebox(use_module::contract_obj, |sc| {
            ...
            let expected_uri = vec![
                TestEsdtTransfer(NFT_TOKEN_ID_EXPR, FIRST_NFT_NONCE, NFT_AMOUNT.into()),
                TestEsdtTransfer(NFT_TOKEN_ID_EXPR, SECOND_NFT_NONCE, NFT_AMOUNT.into()),
            ];
    ...
    let esdt_transfers = vec![
        TestEsdtTransfer(NFT_TOKEN_ID_EXPR, FIRST_NFT_NONCE.into(), NFT_AMOUNT.into()),
        TestEsdtTransfer(FUNGIBLE_TOKEN_ID_EXPR, 0u64.into(), FUNGIBLE_AMOUNT.into()),
    ];
    ...
    world
        ...
        .whitebox(use_module::contract_obj, |sc| {
            ...
            let expected_uri = vec![
                TestEsdtTransfer(NFT_TOKEN_ID_EXPR, FIRST_NFT_NONCE, NFT_AMOUNT.into()),
                TestEsdtTransfer(FUNGIBLE_TOKEN_ID_EXPR, 0, FUNGIBLE_AMOUNT.into()),
            ];
    ...
    let combined_transfers = vec![
        ...
        TestEsdtTransfer(MERGED_TOKEN_ID_EXPR, 2u64.into(), NFT_AMOUNT.into()),
    ];
    ...
    world
        ...
        .from(USER_ADDRESS_EXPR)
        .to(USE_MODULE_ADDRESS_EXPR)
        .payment(TestEsdtTransfer(MERGED_TOKEN_ID_EXPR, 3, NFT_AMOUNT.into()))
        .whitebox(use_module::contract_obj, |sc| {
            let output_tokens = sc.split_tokens_endpoint();
            let expected_output_tokens = vec![
                TestEsdtTransfer(NFT_TOKEN_ID_EXPR, FIRST_NFT_NONCE, NFT_AMOUNT.into()),
