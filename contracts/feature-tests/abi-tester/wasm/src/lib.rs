...
#[no_mangle]
pub fn init() {
    abi_tester::endpoints::init(elrond_wasm_node::arwen_api());
}
...
#[no_mangle]
pub fn echo_enum() {
    abi_tester::endpoints::echo_enum(elrond_wasm_node::arwen_api());
}
...
pub fn multi_result_vec() {
    abi_tester::endpoints::multi_result_vec(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn optional_arg() {
    abi_tester::endpoints::optional_arg(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn optional_result() {
    abi_tester::endpoints::optional_result(elrond_wasm_node::arwen_api());
}
...
#[no_mangle]
pub fn payable_egld() {
    abi_tester::endpoints::payable_egld(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn payable_some_token() {
    abi_tester::endpoints::payable_some_token(elrond_wasm_node::arwen_api());
}
