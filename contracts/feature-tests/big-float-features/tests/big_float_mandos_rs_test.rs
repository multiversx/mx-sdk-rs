...
fn big_float_new_from_big_int_rs() {
    mx_sc_debug::mandos_rs("mandos/big_float_new_from_big_int.scen.json", world());
}

#[test]
fn big_float_new_from_big_uint_rs() {
    mx_sc_debug::mandos_rs("mandos/big_float_new_from_big_uint.scen.json", world());
}

#[test]
fn big_float_new_from_frac_rs() {
    mx_sc_debug::mandos_rs("mandos/big_float_new_from_frac.scen.json", world());
}

#[test]
fn big_float_new_from_int_rs() {
    mx_sc_debug::mandos_rs("mandos/big_float_new_from_int.scen.json", world());
}
...
fn big_float_new_from_parts_rs() {
    mx_sc_debug::mandos_rs("mandos/big_float_new_from_parts.scen.json", world());
}

#[test]
fn big_float_new_from_sci_rs() {
    mx_sc_debug::mandos_rs("mandos/big_float_new_from_sci.scen.json", world());
}

#[test]
fn big_float_operators_rs() {
    mx_sc_debug::mandos_rs("mandos/big_float_operators.scen.json", world());
}

// #[test]
// fn big_float_operator_checks_rs() {
//     mx_sc_debug::mandos_rs("mandos/big_float_operator_checks.scen.json", world());
// }
