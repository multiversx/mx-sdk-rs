...
#[no_mangle]
pub fn init() {
    local_esdt_and_nft::endpoints::init(elrond_wasm_node::arwen_api());
}
...
pub fn getFungibleEsdtBalance() {
    local_esdt_and_nft::endpoints::getFungibleEsdtBalance(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn getNftBalance() {
    local_esdt_and_nft::endpoints::getNftBalance(elrond_wasm_node::arwen_api());
}
...
pub fn lastErrorMessage() {
    local_esdt_and_nft::endpoints::lastErrorMessage(elrond_wasm_node::arwen_api());
}
