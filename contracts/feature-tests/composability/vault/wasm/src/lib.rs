...
#[no_mangle]
pub fn init() {
    vault::endpoints::init(elrond_wasm_node::arwen_api());
}
...
pub fn accept_funds_multi_transfer() {
    vault::endpoints::accept_funds_multi_transfer(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn accept_multi_funds_echo() {
    vault::endpoints::accept_multi_funds_echo(elrond_wasm_node::arwen_api());
}
...
#[no_mangle]
pub fn reject_funds() {
    vault::endpoints::reject_funds(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn retrieve_funds() {
    vault::endpoints::retrieve_funds(elrond_wasm_node::arwen_api());
}
