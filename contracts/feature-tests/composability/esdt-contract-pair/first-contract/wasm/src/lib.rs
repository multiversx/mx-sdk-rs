...
#[no_mangle]
pub fn init() {
    first_contract::endpoints::init(elrond_wasm_node::arwen_api());
}
...
pub fn transferToSecondContractHalf() {
    first_contract::endpoints::transferToSecondContractHalf(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn transferToSecondContractRejected() {
    first_contract::endpoints::transferToSecondContractRejected(elrond_wasm_node::arwen_api());
}
