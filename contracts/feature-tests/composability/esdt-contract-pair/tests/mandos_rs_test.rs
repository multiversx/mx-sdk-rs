...
fn simple_transfer_full_rs() {
    mx_sc_debug::mandos_rs("scenarios/simple_transfer_full.scen.json", world());
}

#[test]
fn simple_transfer_half_rs() {
    mx_sc_debug::mandos_rs("scenarios/simple_transfer_half.scen.json", world());
}

#[test]
fn simple_transfer_full_wrong_token_rs() {
    mx_sc_debug::mandos_rs("scenarios/simple_transfer_full_wrong_token.scen.json", world());
}

// TODO: implement ESDTTransfer + async call
// #[test]
// fn rejected_transfer_rs() {
// 	mx_sc_debug::mandos_rs("scenarios/reject_transfer.scen.json", world());
// }
