...
#[no_mangle]
pub fn init() {
    forwarder_raw::endpoints::init(elrond_wasm_node::arwen_api());
}
...
pub fn callback_data() {
    forwarder_raw::endpoints::callback_data(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn clear_callback_info() {
    forwarder_raw::endpoints::clear_callback_info(elrond_wasm_node::arwen_api());
}
...
pub fn deploy_from_source() {
    forwarder_raw::endpoints::deploy_from_source(elrond_wasm_node::arwen_api());
}
