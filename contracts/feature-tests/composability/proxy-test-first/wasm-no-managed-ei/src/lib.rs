...
#[no_mangle]
pub fn init() {
    proxy_test_first::endpoints::init(elrond_wasm_node::arwen_api());
}
...
pub fn forwardToOtherContract() {
    proxy_test_first::endpoints::forwardToOtherContract(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn forwardToOtherContractWithCallback() {
    proxy_test_first::endpoints::forwardToOtherContractWithCallback(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn messageOtherContract() {
    proxy_test_first::endpoints::messageOtherContract(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn messageOtherContractWithCallback() {
    proxy_test_first::endpoints::messageOtherContractWithCallback(elrond_wasm_node::arwen_api());
}
