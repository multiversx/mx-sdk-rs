...
fn forw_raw_async_accept_egld_rs() {
    mx_sc_debug::mandos_rs("scenarios/forw_raw_async_accept_egld.scen.json", world());
}

#[test]
fn forw_raw_async_accept_esdt_rs() {
    mx_sc_debug::mandos_rs("scenarios/forw_raw_async_accept_esdt.scen.json", world());
}

#[test]
fn forw_raw_async_echo_rs() {
    mx_sc_debug::mandos_rs("scenarios/forw_raw_async_echo.scen.json", world());
}
...
fn forw_raw_contract_deploy_rs() {
    mx_sc_debug::mandos_rs("scenarios/forw_raw_contract_deploy.scen.json", world());
}

#[test]
fn forw_raw_contract_upgrade_rs() {
    mx_sc_debug::mandos_rs("scenarios/forw_raw_contract_upgrade.scen.json", world());
}

#[test]
fn forw_raw_contract_upgrade_self_rs() {
    mx_sc_debug::mandos_rs("scenarios/forw_raw_contract_upgrade_self.scen.json", world());
}

#[test]
fn forw_raw_direct_egld_rs() {
    mx_sc_debug::mandos_rs("scenarios/forw_raw_direct_egld.scen.json", world());
}

#[test]
fn forw_raw_direct_esdt_rs() {
    mx_sc_debug::mandos_rs("scenarios/forw_raw_direct_esdt.scen.json", world());
}

#[test]
fn forw_raw_direct_multi_esdt_rs() {
    mx_sc_debug::mandos_rs("scenarios/forw_raw_direct_multi_esdt.scen.json", world());
}

#[test]
fn forw_raw_sync_echo_rs() {
    mx_sc_debug::mandos_rs("scenarios/forw_raw_sync_echo.scen.json", world());
}

#[test]
fn forw_raw_sync_echo_caller_rs() {
    mx_sc_debug::mandos_rs("scenarios/forw_raw_sync_echo_caller.scen.json", world());
}

#[test]
fn forw_raw_sync_egld_rs() {
    mx_sc_debug::mandos_rs("scenarios/forw_raw_sync_egld.scen.json", world());
}

// #[test]
// fn forw_raw_sync_readonly_rs() {
//     mx_sc_debug::mandos_rs("scenarios/forw_raw_sync_readonly.scen.json", world());
// }

// #[test]
// fn forw_raw_sync_same_context_rs() {
//     mx_sc_debug::mandos_rs("scenarios/forw_raw_sync_same_context.scen.json", world());
// }

// #[test]
// fn forw_raw_sync_same_context_egld_rs() {
//     mx_sc_debug::mandos_rs("scenarios/forw_raw_sync_same_context_egld.scen.json", world());
// }

#[test]
fn forw_raw_transf_exec_accept_egld_rs() {
    mx_sc_debug::mandos_rs("scenarios/forw_raw_transf_exec_accept_egld.scen.json", world());
}

#[test]
fn forw_raw_transf_exec_reject_egld_rs() {
    mx_sc_debug::mandos_rs("scenarios/forw_raw_transf_exec_reject_egld.scen.json", world());
}
...
fn forwarder_builtin_nft_burn_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_builtin_nft_burn.scen.json", world());
}

#[test]
fn forwarder_builtin_nft_create_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_builtin_nft_create.scen.json", world());
}

#[test]
fn forwarder_builtin_nft_local_burn_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_builtin_nft_local_burn.scen.json", world());
}

#[test]
fn forwarder_builtin_nft_local_mint_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_builtin_nft_local_mint.scen.json", world());
}

#[test]
fn forwarder_call_async_accept_egld_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_call_async_accept_egld.scen.json", world());
}

#[test]
fn forwarder_call_async_accept_esdt_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_call_async_accept_esdt.scen.json", world());
}

#[test]
fn forwarder_call_async_accept_nft_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_call_async_accept_nft.scen.json", world());
}
...
fn forwarder_call_sync_accept_egld_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_call_sync_accept_egld.scen.json", world());
}

#[test]
fn forwarder_call_sync_accept_esdt_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_call_sync_accept_esdt.scen.json", world());
}
...
fn forwarder_call_sync_accept_nft_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_call_sync_accept_nft.scen.json", world());
}
...
fn forwarder_call_sync_retrieve_nft_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_call_sync_retrieve_nft.scen.json", world());
}
...
fn forwarder_contract_change_owner_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_contract_change_owner.scen.json", world());
}

#[test]
fn forwarder_contract_deploy_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_contract_deploy.scen.json", world());
}

#[test]
fn forwarder_contract_upgrade_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_contract_upgrade.scen.json", world());
}

#[test]
fn forwarder_get_esdt_local_roles_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_get_esdt_local_roles.scen.json", world());
}

#[test]
fn forwarder_get_esdt_token_data_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_get_esdt_token_data.scen.json", world());
}

#[test]
fn forwarder_nft_add_uri_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_nft_add_uri.scen.json", world());
}

#[test]
fn forwarder_nft_create_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_nft_create.scen.json", world());
}

#[test]
fn forwarder_nft_create_and_send_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_nft_create_and_send.scen.json", world());
}

#[test]
fn forwarder_nft_current_nonce_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_nft_current_nonce.scen.json", world());
}
...
fn forwarder_nft_transfer_async_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_nft_transfer_async.scen.json", world());
}

#[test]
fn forwarder_nft_transfer_exec_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_nft_transfer_exec.scen.json", world());
}

#[test]
fn forwarder_nft_update_attributes_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_nft_update_attributes.scen.json", world());
}

#[test]
fn forwarder_no_endpoint_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_no_endpoint.scen.json", world());
}
...
//     mx_sc_debug::mandos_rs("scenarios/forwarder_send_twice_egld.scen.json", world());
// }

// #[test]
// fn forwarder_send_twice_esdt_rs() {
//     mx_sc_debug::mandos_rs("scenarios/forwarder_send_twice_esdt.scen.json", world());
// }

#[test]
fn forwarder_sync_echo_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_sync_echo.scen.json", world());
}

#[test]
fn forwarder_tranfer_esdt_with_fees_rs() {
    mx_sc_debug::mandos_rs("scenarios/forwarder_tranfer_esdt_with_fees.scen.json", world());
}
...
fn promises_multi_transfer_rs() {
    mx_sc_debug::mandos_rs("scenarios-promises/promises_multi_transfer.scen.json", world());
}

// #[test]
// fn promises_single_transfer_rs() {
//     mx_sc_debug::mandos_rs("scenarios-promises/promises_single_transfer.scen.json", world());
// }

#[test]
fn proxy_test_init_rs() {
    mx_sc_debug::mandos_rs("scenarios/proxy_test_init.scen.json", world());
}

#[test]
fn proxy_test_message_othershard_rs() {
    mx_sc_debug::mandos_rs("scenarios/proxy_test_message_otherShard.scen.json", world());
}
...
fn proxy_test_message_sameshard_rs() {
    mx_sc_debug::mandos_rs("scenarios/proxy_test_message_sameShard.scen.json", world());
}
...
fn proxy_test_payment_othershard_rs() {
    mx_sc_debug::mandos_rs("scenarios/proxy_test_payment_otherShard.scen.json", world());
}
...
fn proxy_test_payment_sameshard_rs() {
    mx_sc_debug::mandos_rs("scenarios/proxy_test_payment_sameShard.scen.json", world());
}
...
fn proxy_test_upgrade_rs() {
    mx_sc_debug::mandos_rs("scenarios/proxy_test_upgrade.scen.json", world());
}

#[test]
fn recursive_caller_egld_1_rs() {
    mx_sc_debug::mandos_rs("scenarios/recursive_caller_egld_1.scen.json", world());
}

#[test]
fn recursive_caller_esdt_1_rs() {
    mx_sc_debug::mandos_rs("scenarios/recursive_caller_esdt_1.scen.json", world());
}

#[test]
fn send_egld_rs() {
    mx_sc_debug::mandos_rs("scenarios/send_egld.scen.json", world());
}

#[test]
fn send_esdt_rs() {
    mx_sc_debug::mandos_rs("scenarios/send_esdt.scen.json", world());
}
