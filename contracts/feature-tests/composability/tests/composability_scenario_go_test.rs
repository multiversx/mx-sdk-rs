...
fn forw_raw_async_accept_esdt_go() {
    multiversx_sc_scenario::run_go("scenarios/forw_raw_async_accept_esdt.scen.json");
}

#[test]
fn forw_raw_async_echo_go() {
    multiversx_sc_scenario::run_go("scenarios/forw_raw_async_echo.scen.json");
}
...
fn forw_raw_contract_deploy_go() {
    multiversx_sc_scenario::run_go("scenarios/forw_raw_contract_deploy.scen.json");
}

#[test]
fn forw_raw_contract_upgrade_go() {
    multiversx_sc_scenario::run_go("scenarios/forw_raw_contract_upgrade.scen.json");
}

#[test]
fn forw_raw_contract_upgrade_self_go() {
    multiversx_sc_scenario::run_go("scenarios/forw_raw_contract_upgrade_self.scen.json");
}

#[test]
fn forw_raw_direct_egld_go() {
    multiversx_sc_scenario::run_go("scenarios/forw_raw_direct_egld.scen.json");
}

#[test]
fn forw_raw_direct_esdt_go() {
    multiversx_sc_scenario::run_go("scenarios/forw_raw_direct_esdt.scen.json");
}
...
fn forw_raw_init_sync_accept_egld_go() {
    multiversx_sc_scenario::run_go("scenarios/forw_raw_init_sync_accept_egld.scen.json");
}

#[test]
fn forw_raw_init_sync_echo_go() {
    multiversx_sc_scenario::run_go("scenarios/forw_raw_init_sync_echo.scen.json");
}

#[test]
fn forw_raw_sync_echo_go() {
    multiversx_sc_scenario::run_go("scenarios/forw_raw_sync_echo.scen.json");
}

#[test]
fn forw_raw_sync_echo_caller_go() {
    multiversx_sc_scenario::run_go("scenarios/forw_raw_sync_echo_caller.scen.json");
}

#[test]
fn forw_raw_sync_egld_go() {
    multiversx_sc_scenario::run_go("scenarios/forw_raw_sync_egld.scen.json");
}

#[test]
fn forw_raw_sync_readonly_go() {
    multiversx_sc_scenario::run_go("scenarios/forw_raw_sync_readonly.scen.json");
}

#[test]
fn forw_raw_sync_same_context_go() {
    multiversx_sc_scenario::run_go("scenarios/forw_raw_sync_same_context.scen.json");
}

#[test]
fn forw_raw_sync_same_context_egld_go() {
    multiversx_sc_scenario::run_go("scenarios/forw_raw_sync_same_context_egld.scen.json");
}

#[test]
fn forw_raw_transf_exec_accept_egld_go() {
    multiversx_sc_scenario::run_go("scenarios/forw_raw_transf_exec_accept_egld.scen.json");
}

#[test]
fn forw_raw_transf_exec_reject_egld_go() {
    multiversx_sc_scenario::run_go("scenarios/forw_raw_transf_exec_reject_egld.scen.json");
}

#[test]
fn forwarder_builtin_nft_add_quantity_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_builtin_nft_add_quantity.scen.json");
}

#[test]
fn forwarder_builtin_nft_burn_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_builtin_nft_burn.scen.json");
}

#[test]
fn forwarder_builtin_nft_create_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_builtin_nft_create.scen.json");
}

#[test]
fn forwarder_builtin_nft_local_burn_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_builtin_nft_local_burn.scen.json");
}

#[test]
fn forwarder_builtin_nft_local_mint_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_builtin_nft_local_mint.scen.json");
}

#[test]
fn forwarder_call_async_accept_egld_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_async_accept_egld.scen.json");
}

#[test]
fn forwarder_call_async_accept_esdt_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_async_accept_esdt.scen.json");
}

#[test]
fn forwarder_call_async_accept_nft_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_async_accept_nft.scen.json");
}

#[test]
fn forwarder_call_async_multi_transfer_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_async_multi_transfer.scen.json");
}

#[test]
fn forwarder_call_async_retrieve_egld_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_async_retrieve_egld.scen.json");
}
...
fn forwarder_call_async_retrieve_nft_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_async_retrieve_nft.scen.json");
}

#[test]
fn forwarder_call_sync_accept_egld_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_sync_accept_egld.scen.json");
}

#[test]
fn forwarder_call_sync_accept_esdt_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_sync_accept_esdt.scen.json");
}

#[test]
fn forwarder_call_sync_accept_multi_transfer_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_sync_accept_multi_transfer.scen.json");
}

#[test]
fn forwarder_call_sync_accept_nft_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_sync_accept_nft.scen.json");
}

#[test]
fn forwarder_call_sync_accept_then_read_egld_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_sync_accept_then_read_egld.scen.json");
}

#[test]
fn forwarder_call_sync_accept_then_read_esdt_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_sync_accept_then_read_esdt.scen.json");
}

#[test]
fn forwarder_call_sync_accept_then_read_nft_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_sync_accept_then_read_nft.scen.json");
}

#[test]
fn forwarder_call_sync_retrieve_egld_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_sync_retrieve_egld.scen.json");
}

#[test]
fn forwarder_call_sync_retrieve_esdt_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_sync_retrieve_esdt.scen.json");
}

#[test]
fn forwarder_call_sync_retrieve_nft_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_sync_retrieve_nft.scen.json");
}

#[test]
fn forwarder_call_transf_exec_accept_egld_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_transf_exec_accept_egld.scen.json");
}
...
fn forwarder_call_transf_exec_accept_esdt_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_transf_exec_accept_esdt.scen.json");
}
...
fn forwarder_call_transf_exec_accept_nft_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_transf_exec_accept_nft.scen.json");
}
...
fn forwarder_call_transf_exec_reject_nft_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_call_transf_exec_reject_nft.scen.json");
}

#[test]
fn forwarder_contract_change_owner_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_contract_change_owner.scen.json");
}

#[test]
fn forwarder_contract_deploy_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_contract_deploy.scen.json");
}

#[test]
fn forwarder_contract_upgrade_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_contract_upgrade.scen.json");
}

#[test]
fn forwarder_get_esdt_local_roles_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_get_esdt_local_roles.scen.json");
}

#[test]
fn forwarder_get_esdt_token_data_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_get_esdt_token_data.scen.json");
}

#[test]
fn forwarder_nft_add_uri_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_nft_add_uri.scen.json");
}

#[test]
fn forwarder_nft_create_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_nft_create.scen.json");
}

#[test]
fn forwarder_nft_create_and_send_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_nft_create_and_send.scen.json");
}

#[test]
fn forwarder_nft_current_nonce_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_nft_current_nonce.scen.json");
}

#[test]
fn forwarder_nft_decode_complex_attributes_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_nft_decode_complex_attributes.scen.json");
}

#[test]
fn forwarder_nft_transfer_async_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_nft_transfer_async.scen.json");
}

#[test]
fn forwarder_nft_transfer_exec_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_nft_transfer_exec.scen.json");
}

#[test]
fn forwarder_nft_update_attributes_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_nft_update_attributes.scen.json");
}

#[test]
fn forwarder_no_endpoint_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_no_endpoint.scen.json");
}

#[test]
fn forwarder_retrieve_funds_with_accept_func_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_retrieve_funds_with_accept_func.scen.json");
}

#[test]
fn forwarder_send_esdt_multi_transfer_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_send_esdt_multi_transfer.scen.json");
}

#[test]
fn forwarder_send_twice_egld_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_send_twice_egld.scen.json");
}

#[test]
fn forwarder_send_twice_esdt_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_send_twice_esdt.scen.json");
}

#[test]
fn forwarder_sync_echo_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_sync_echo.scen.json");
}

#[test]
fn forwarder_tranfer_esdt_with_fees_go() {
    multiversx_sc_scenario::run_go("scenarios/forwarder_tranfer_esdt_with_fees.scen.json");
}
...
fn proxy_test_upgrade_go() {
    multiversx_sc_scenario::run_go("scenarios/proxy_test_upgrade.scen.json");
}

#[test]
fn recursive_caller_egld_1_go() {
    multiversx_sc_scenario::run_go("scenarios/recursive_caller_egld_1.scen.json");
}

#[test]
fn recursive_caller_esdt_1_go() {
    multiversx_sc_scenario::run_go("scenarios/recursive_caller_esdt_1.scen.json");
}

#[test]
fn send_egld_go() {
    multiversx_sc_scenario::run_go("scenarios/send_egld.scen.json");
}

#[test]
fn send_esdt_go() {
    multiversx_sc_scenario::run_go("scenarios/send_esdt.scen.json");
}
