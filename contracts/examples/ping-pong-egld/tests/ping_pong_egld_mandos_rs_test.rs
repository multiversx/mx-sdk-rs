...
fn ping_pong_call_ping_twice_rs() {
    elrond_wasm_debug::mandos_rs("mandos/ping-pong-call-ping-twice.scen.json", contract_map());
}
...
fn ping_pong_call_pong_twice_rs() {
    elrond_wasm_debug::mandos_rs("mandos/ping-pong-call-pong-twice.scen.json", contract_map());
}
