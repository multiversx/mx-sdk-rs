...
async fn test_ping_pong_egld() {
    ...
    let duration_in_ms = 5000u64;
    let opt_activation_timestamp = 2000u64;
    ...
    let duration_in_ms = 5000u64;
    let opt_activation_timestamp = 2_000_000_000_000u64;
    let max_funds = 100_000u64;
    ...
    let duration_in_ms = 30000000u64;
    let max_funds = 10u64;
