...
#[no_mangle]
pub fn init() {
    lottery_esdt::endpoints::init(elrond_wasm_node::arwen_api());
}
...
#[no_mangle]
pub fn buy_ticket() {
    lottery_esdt::endpoints::buy_ticket(elrond_wasm_node::arwen_api());
}
...
pub fn getLotteryInfo() {
    lottery_esdt::endpoints::getLotteryInfo(elrond_wasm_node::arwen_api());
}
