...
pub trait Adder: multiversx_sc::contract_base::ContractBase + Sized {
...
{}
pub trait EndpointWrappers: multiversx_sc::contract_base::ContractBase + Adder {
    #[inline]
    fn call_sum(&self) {
...
impl multiversx_sc::contract_base::ContractAbiProvider for AbiProvider {
    ...
    fn abi() -> multiversx_sc::abi::ContractAbi {
        ...
        endpoint_abi
            .add_input::<multiversx_sc::types::BigUint<Self::Api>>("initial_value");
