...
#[no_mangle]
pub fn init() {
    kitty_ownership::endpoints::init(elrond_wasm_node::arwen_api());
}
...
pub fn allowAuctioning() {
    kitty_ownership::endpoints::allowAuctioning(elrond_wasm_node::arwen_api());
}
...
pub fn createGenZeroKitty() {
    kitty_ownership::endpoints::createGenZeroKitty(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn getKittyById() {
    kitty_ownership::endpoints::getKittyById(elrond_wasm_node::arwen_api());
}
...
#[no_mangle]
pub fn isPregnant() {
    kitty_ownership::endpoints::isPregnant(elrond_wasm_node::arwen_api());
}
