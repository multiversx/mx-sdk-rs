...
fn interactor_nft_go() {
    multiversx_sc_scenario::run_go("scenarios/interactor_nft.scen.json");
}

#[test]
fn interactor_nft_all_roles_go() {
    multiversx_sc_scenario::run_go("scenarios/interactor_nft_all_roles.scen.json");
}

#[test]
fn interactor_wegld_go() {
    multiversx_sc_scenario::run_go("scenarios/interactor_wegld.scen.json");
}
