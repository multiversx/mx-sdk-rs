...
pub fn pay_fee_and_fund_esdt_single_scen_steps(world: &mut ScenarioWorld) {
    ...
    world.tx()
        ...
        .pay_fee_and_fund(ScenarioValueRaw::str("0xdb474a3a065d3f0c0a62ae680ef6435e48eb482899d2ae30ff7a3a4b0ef19c60"), ScenarioValueRaw::str("86400_000"))
        .run();
...
pub fn forward_scen_steps(world: &mut ScenarioWorld) {
    ...
    world.tx()
        ...
        .to(THE_DIGITAL_CASH_CONTRACT_ADDRESS)
        .typed(digital_cash_proxy::DigitalCashProxy)
        .deposit_fees(ScenarioValueRaw::str("0xa40e72cdac3580e7203a4c2565c932f7691c35e624bcfd82718d7f559c88f440"))
        .run();
    ...
    world.tx()
        ...
        .to(THE_DIGITAL_CASH_CONTRACT_ADDRESS)
        .typed(digital_cash_proxy::DigitalCashProxy)
        .deposit_fees(ScenarioValueRaw::str("0x8dc17613990e9b7476401a36d112d1a4d31190dec21e7e9a3c933872a27613ee"))
        .run();
...
pub fn fund_egld_and_esdt_scen_steps(world: &mut ScenarioWorld) {
    ...
    world.tx()
        ...
        .to(THE_DIGITAL_CASH_CONTRACT_ADDRESS)
        .typed(digital_cash_proxy::DigitalCashProxy)
        .fund(ScenarioValueRaw::str("0xdb474a3a065d3f0c0a62ae680ef6435e48eb482899d2ae30ff7a3a4b0ef19c60"), ScenarioValueRaw::str("86400_000"))
        .run();
    ...
    world.tx()
        ...
        .to(THE_DIGITAL_CASH_CONTRACT_ADDRESS)
        .typed(digital_cash_proxy::DigitalCashProxy)
        .deposit_fees(ScenarioValueRaw::str("0xdb474a3a065d3f0c0a62ae680ef6435e48eb482899d2ae30ff7a3a4b0ef19c60"))
        .run();
    ...
    world.tx()
        ...
        .to(THE_DIGITAL_CASH_CONTRACT_ADDRESS)
        .typed(digital_cash_proxy::DigitalCashProxy)
        .fund(ScenarioValueRaw::str("0xdb474a3a065d3f0c0a62ae680ef6435e48eb482899d2ae30ff7a3a4b0ef19c60"), ScenarioValueRaw::str("86399_000"))
        .run();
    ...
    world.tx()
        ...
        .to(THE_DIGITAL_CASH_CONTRACT_ADDRESS)
        .typed(digital_cash_proxy::DigitalCashProxy)
        .deposit_fees(ScenarioValueRaw::str("0x487bd4010b50c24a02018345fe5171edf4182e6294325382c75ef4c4409f01bd"))
        .run();
    ...
    world.tx()
        ...
        .to(THE_DIGITAL_CASH_CONTRACT_ADDRESS)
        .typed(digital_cash_proxy::DigitalCashProxy)
        .fund(ScenarioValueRaw::str("0x487bd4010b50c24a02018345fe5171edf4182e6294325382c75ef4c4409f01bd"), ScenarioValueRaw::str("86400_000"))
        .run();
    ...
    world.tx()
        ...
        .to(THE_DIGITAL_CASH_CONTRACT_ADDRESS)
        .typed(digital_cash_proxy::DigitalCashProxy)
        .deposit_fees(ScenarioValueRaw::str("0x885532043a061e0c779e4064b85193f72cffd22c5bcc208c209128e60f21bf0d"))
        .run();
    ...
    world.tx()
        ...
        .to(THE_DIGITAL_CASH_CONTRACT_ADDRESS)
        .typed(digital_cash_proxy::DigitalCashProxy)
        .fund(ScenarioValueRaw::str("0x885532043a061e0c779e4064b85193f72cffd22c5bcc208c209128e60f21bf0d"), ScenarioValueRaw::str("86400_000"))
        .run();
...
pub fn set_accounts_scen_steps(world: &mut ScenarioWorld) {
    world.account(ACC1_ADDRESS).nonce(ScenarioValueRaw::str("0"))
        .balance(ScenarioValueRaw::str("1,000,000"))
        ;
    world.account(ACC2_ADDRESS).nonce(ScenarioValueRaw::str("0"))
        .balance(ScenarioValueRaw::str("1,000,000"))
        ;
    world.account(ACC3_ADDRESS).nonce(ScenarioValueRaw::str("0"))
        .balance(ScenarioValueRaw::str("1,000,000"))
        ;
    world.account(DIGITAL_CASH_OWNER_ADDRESS_ADDRESS).nonce(ScenarioValueRaw::str("0"))
...
pub fn withdraw_esdt_scen_steps(world: &mut ScenarioWorld) {
    ...
    world.tx()
        ...
        .to(THE_DIGITAL_CASH_CONTRACT_ADDRESS)
        .typed(digital_cash_proxy::DigitalCashProxy)
        .withdraw_expired(ScenarioValueRaw::str("0x487bd4010b50c24a02018345fe5171edf4182e6294325382c75ef4c4409f01bd"))
        .run();
    ...
    world.tx()
        ...
        .to(THE_DIGITAL_CASH_CONTRACT_ADDRESS)
        .typed(digital_cash_proxy::DigitalCashProxy)
        .withdraw_expired(ScenarioValueRaw::str("0xe808c2baab2a20b612f1351da5945c52c60f5321c6cde572149db90c9e8fbfc7"))
        .run();
...
pub fn withdraw_egld_scen_steps(world: &mut ScenarioWorld) {
    ...
    world.tx()
        ...
        .to(THE_DIGITAL_CASH_CONTRACT_ADDRESS)
        .typed(digital_cash_proxy::DigitalCashProxy)
        .withdraw_expired(ScenarioValueRaw::str("0xdb474a3a065d3f0c0a62ae680ef6435e48eb482899d2ae30ff7a3a4b0ef19c60"))
        .run();
    ...
    world.tx()
        ...
        .to(THE_DIGITAL_CASH_CONTRACT_ADDRESS)
        .typed(digital_cash_proxy::DigitalCashProxy)
        .withdraw_expired(ScenarioValueRaw::str("0x558fd9b0dd9fed2d3bed883d3b92907743362c56b9728392f84b261f1cc5ae0a"))
        .run();
...
pub fn withdraw_multi_esdt_scen_steps(world: &mut ScenarioWorld) {
    ...
    world.tx()
        ...
        .to(THE_DIGITAL_CASH_CONTRACT_ADDRESS)
        .typed(digital_cash_proxy::DigitalCashProxy)
        .withdraw_expired(ScenarioValueRaw::str("0x805532043a061e0c779e4064b85193f72cffd22c5bcc208c209128e60f21bf0d"))
        .run();
    ...
    world.tx()
        ...
        .to(THE_DIGITAL_CASH_CONTRACT_ADDRESS)
        .typed(digital_cash_proxy::DigitalCashProxy)
        .withdraw_expired(ScenarioValueRaw::str("0x885532043a061e0c779e4064b85193f72cffd22c5bcc208c209128e60f21bf0d"))
        .run();
...
pub fn whitelist_blacklist_fee_tokens_scen_steps(world: &mut ScenarioWorld) {
    ...
    world.tx()
        ...
        .to(THE_DIGITAL_CASH_CONTRACT_ADDRESS)
        .typed(digital_cash_proxy::DigitalCashProxy)
        .set_fee(ScenarioValueRaw::str("str:CASHTOKEN-778899"), ScenarioValueRaw::str("3"))
        .run();
    ...
    world.tx()
        ...
        .to(THE_DIGITAL_CASH_CONTRACT_ADDRESS)
        .typed(digital_cash_proxy::DigitalCashProxy)
        .set_fee(ScenarioValueRaw::str("str:ESDT-778899"), ScenarioValueRaw::str("5"))
        .run();
    ...
    world.tx()
        ...
        .to(THE_DIGITAL_CASH_CONTRACT_ADDRESS)
        .typed(digital_cash_proxy::DigitalCashProxy)
        .set_fee(ScenarioValueRaw::str("str:ESDT-778899"), ScenarioValueRaw::str("0"))
        .run();
