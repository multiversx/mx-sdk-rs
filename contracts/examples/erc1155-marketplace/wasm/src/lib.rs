...
#[no_mangle]
pub fn init() {
    erc1155_marketplace::endpoints::init(elrond_wasm_node::arwen_api());
}
...
pub fn onERC1155BatchReceived() {
    erc1155_marketplace::endpoints::onERC1155BatchReceived(elrond_wasm_node::arwen_api());
}
...
pub fn setCutPercentage() {
    erc1155_marketplace::endpoints::setCutPercentage(elrond_wasm_node::arwen_api());
}
