...
fn crowdfunding_claim_failed_rs() {
    multiversx_sc_scenario::scenario_rs("scenarios/crowdfunding-claim-failed.scen.json", world());
}

#[test]
fn crowdfunding_claim_successful_rs() {
    multiversx_sc_scenario::scenario_rs(
        "scenarios/crowdfunding-claim-successful.scen.json",
        world(),
    );
}
...
fn crowdfunding_claim_too_early_rs() {
    multiversx_sc_scenario::scenario_rs(
        "scenarios/crowdfunding-claim-too-early.scen.json",
        world(),
    );
}
...
fn crowdfunding_fund_rs() {
    multiversx_sc_scenario::scenario_rs("scenarios/crowdfunding-fund.scen.json", world());
}

#[test]
fn crowdfunding_fund_too_late_rs() {
    multiversx_sc_scenario::scenario_rs("scenarios/crowdfunding-fund-too-late.scen.json", world());
}

#[test]
fn crowdfunding_init_rs() {
    multiversx_sc_scenario::scenario_rs("scenarios/crowdfunding-init.scen.json", world());
}
...
fn egld_crowdfunding_fund_rs() {
    multiversx_sc_scenario::scenario_rs("scenarios/egld-crowdfunding-fund.scen.json", world());
}
...
fn egld_crowdfunding_init_rs() {
    multiversx_sc_scenario::scenario_rs("scenarios/egld-crowdfunding-init.scen.json", world());
}
