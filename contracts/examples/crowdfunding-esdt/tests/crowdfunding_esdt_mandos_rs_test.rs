...
fn crowdfunding_claim_failed_rs() {
    mx_sc_debug::scenario_rs("scenarios/crowdfunding-claim-failed.scen.json", world());
}

#[test]
fn crowdfunding_claim_successful_rs() {
    mx_sc_debug::scenario_rs("scenarios/crowdfunding-claim-successful.scen.json", world());
}

#[test]
fn crowdfunding_claim_too_early_rs() {
    mx_sc_debug::scenario_rs("scenarios/crowdfunding-claim-too-early.scen.json", world());
}

#[test]
fn crowdfunding_fund_rs() {
    mx_sc_debug::scenario_rs("scenarios/crowdfunding-fund.scen.json", world());
}

#[test]
fn crowdfunding_fund_too_late_rs() {
    mx_sc_debug::scenario_rs("scenarios/crowdfunding-fund-too-late.scen.json", world());
}

#[test]
fn crowdfunding_init_rs() {
    mx_sc_debug::scenario_rs("scenarios/crowdfunding-init.scen.json", world());
}
...
fn egld_crowdfunding_fund_rs() {
    mx_sc_debug::scenario_rs("scenarios/egld-crowdfunding-fund.scen.json", world());
}
...
fn egld_crowdfunding_init_rs() {
    mx_sc_debug::scenario_rs("scenarios/egld-crowdfunding-init.scen.json", world());
}
