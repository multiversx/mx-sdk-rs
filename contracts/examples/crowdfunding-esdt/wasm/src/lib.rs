...
#[no_mangle]
pub fn init() {
    crowdfunding_esdt::endpoints::init(elrond_wasm_node::arwen_api());
}
...
#[no_mangle]
pub fn claim() {
    crowdfunding_esdt::endpoints::claim(elrond_wasm_node::arwen_api());
}
...
#[no_mangle]
pub fn getDeadline() {
    crowdfunding_esdt::endpoints::getDeadline(elrond_wasm_node::arwen_api());
}

#[no_mangle]
pub fn getDeposit() {
    crowdfunding_esdt::endpoints::getDeposit(elrond_wasm_node::arwen_api());
}
