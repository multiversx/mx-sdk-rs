...
Developers are recommended to directly use the [**sc-meta**](https://docs.multiversx.com/developers/meta/sc-meta-cli) tool - of the [**SpaceCraft**](https://github.com/multiversx/mx-sdk-rs) Rust framework - in order to build and test smart contracts.
