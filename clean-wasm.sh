...
erdpy --verbose contract clean "contracts/examples/egld-esdt-swap"
erdpy --verbose contract clean "contracts/examples/erc20"
...
erdpy --verbose contract clean "contracts/feature-tests/async/recursive-caller"
