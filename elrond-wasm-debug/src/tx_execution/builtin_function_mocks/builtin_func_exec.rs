...
use super::{
    change_owner_mock::execute_change_owner, esdt_create_nft_mock::execute_esdt_create_nft,
...
use elrond_wasm::api::{
    CHANGE_OWNER_BUILTIN_FUNC_NAME, ESDT_MULTI_TRANSFER_FUNC_NAME, ESDT_NFT_CREATE_FUNC_NAME,
    ESDT_NFT_TRANSFER_FUNC_NAME, ESDT_TRANSFER_FUNC_NAME, SET_USERNAME_FUNC_NAME,
...
pub fn execute_builtin_function_or_default(
    ...
    match tx_input.func_name.as_slice() {
        ...
        ESDT_NFT_CREATE_FUNC_NAME => execute_esdt_create_nft(tx_input, tx_cache),
