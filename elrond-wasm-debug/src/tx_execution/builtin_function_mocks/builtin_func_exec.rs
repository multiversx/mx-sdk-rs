...
use super::{
    ...
    esdt_nft_transfer_mock::execute_esdt_nft_transfer,
    esdt_nft_update_attriutes_mock::execute_esdt_nft_update_attriutes,
    esdt_transfer_mock::execute_esdt_transfer, set_username_mock::execute_set_username,
...
use elrond_wasm::api::{
    ...
    ESDT_NFT_UPDATE_ATTRIBUTES_FUNC_NAME, ESDT_TRANSFER_FUNC_NAME, SET_USERNAME_FUNC_NAME,
...
pub fn execute_builtin_function_or_default(
    ...
    match tx_input.func_name.as_slice() {
        ...
        ESDT_NFT_UPDATE_ATTRIBUTES_FUNC_NAME => check_and_execute_builtin_function(
            ESDT_ROLE_NFT_UPDATE_ATTRIBUTES,
            tx_input,
            tx_cache,
            &execute_esdt_nft_update_attriutes,
        ),
