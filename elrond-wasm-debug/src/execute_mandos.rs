        ...
        match step {
            ...
            Step::SetState {
                ...
                for (address, account) in accounts.iter() {
                    state.add_account(AccountData{
                        ...
                        esdt: account.esdt.as_ref().map(|tree| tree.iter().map(|(k, v)| (k.value.clone(), v.value.clone())).collect()),
            ...
            Step::ScCall {
                ...
                let tx_input = TxInput{
                    ...
                    esdt_value: tx.esdt_value.as_ref().map_or(BigUint::from(0u32), |val| val.value.clone()),
                    esdt_token_name: tx.esdt_token_name.as_ref().map(|name| name.as_bytes().to_vec()),
