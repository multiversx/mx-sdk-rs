...
#[test]
#[should_panic]
fn set_account_sc_addr_len_err1_rs() {
    elrond_wasm_debug::mandos_rs(
        "tests/mandos/set-check/set-account-sc-addr-len.err1.json",
        &contract_map(),
    );
}
...
#[test]
#[should_panic]
fn set_account_sc_addr_len_err2_rs() {
    elrond_wasm_debug::mandos_rs(
        "tests/mandos/set-check/set-account-sc-addr-len.err2.json",
        &contract_map(),
    );
}
...
#[test]
#[should_panic]
fn set_account_sc_addr_len_err3_rs() {
    elrond_wasm_debug::mandos_rs(
        "tests/mandos/set-check/set-account-sc-addr-len.err3.json",
        &contract_map(),
    );
}
