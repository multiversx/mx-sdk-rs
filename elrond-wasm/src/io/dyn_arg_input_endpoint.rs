...
where
    AA: EndpointArgumentApi + ManagedTypeApi + 'static,
{
    api: AA,
    current_index: i32,
    num_arguments: i32,
...
impl<AA> DynArgInput<AA, ArgDecodeInput<AA>> for EndpointDynArgLoader<AA>
where
    AA: EndpointArgumentApi + ManagedTypeApi + Clone + 'static,
{
