...
impl EndpointArgumentApiImpl for UncallableApi {
    ...
    fn get_argument_big_int_raw(&self, _arg_id: i32, _dest: Handle) {
        unreachable!()
    }

    fn get_argument_big_uint_raw(&self, _arg_id: i32, _dest: Handle) {
        unreachable!()
    }

    fn get_argument_managed_buffer_raw(&self, _arg_id: i32, _dest: Handle) {
        unreachable!()
    }
