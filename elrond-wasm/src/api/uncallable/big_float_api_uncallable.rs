...
impl BigFloatApi for super::UncallableApi{
    ...
    fn bf_sqrt(&self, _dest: Handle,x: Handle){
        unreachable!()
    }
    fn bf_pow(&self, _dest: Handle,x: Handle,y: Handle){
        unreachable!()
    }
    ...
    fn bf_ceil(&self, _dest: Handle,x: Handle){
        unreachable!()
    }
    fn bf_trunc(&self, _dest: Handle,x: Handle){
        unreachable!()
    }
    ...
    fn bf__get_const_e(&self, _dest: Handle){
        unreachable!()
    }
}
