    ...
    A: VMApi,
{
    ...
    fn load_external_view_target_key_handle(&self) {
        let external_view_target_key_handle = use_raw_handle(const_handles::MBUF_TEMPORARY_1);
...
impl<A: VMApi> StorageReadApiImpl for ExternalViewApi<A> {
    ...
    fn storage_load_len(&self, key: &[u8]) -> usize {
        ...
        A::managed_type_impl().mb_overwrite(mbuf_temp_1, key);
        let mbuf_temp_2 = use_raw_handle(const_handles::MBUF_TEMPORARY_2);
        self.storage_load_managed_buffer_raw(mbuf_temp_1, mbuf_temp_2);
