...
impl<M: ManagedTypeApi> PartialEq for BigFloat<M> {
    ...
    fn eq(&self, other: &Self) -> bool {
        self.api.bf_cmp(self.handle, other.handle).is_eq()
    }
}
